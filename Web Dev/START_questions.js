...
function submitAnswer(){
  var total = 0;
  var categories = ["colors", "shapes", "letters"];
...
var veggie;
if (total < 5){
  veggie = "Bob the Tomato uwu";

}
else if (total < 10){
  veggie = "Larry the Cucumber uwu";
}
else{
  veggie = "Laura Carrot uwu";
}



  /*TODO: Replace the empty quotes with the result of the quiz*/
  document.getElementById("results").innerHTML = "YOU ARE  "  + veggie.toUpperCase();
}
